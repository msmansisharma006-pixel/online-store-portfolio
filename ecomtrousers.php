...
<div class="row row-cols-2 row-cols-lg-3 g-3">
    <?php 
    // Fetch products specifically from tblproduct3 for the trousers page
    $query = "SELECT * FROM tblproduct3";
    $result = mysqli_query($conn, $query);
    ...
    ?>
        <div class="col">
            <div class="card custom-card" style="border:none;">
                <!-- Product Image -->
                <img src="images/trousers/<?php echo htmlspecialchars($product['image']); ?>" class="card-img-top" alt="Product Image">
                ...
                <div class="card-body">
                    ...
                    <a href="index.php?action=add&pid=<?php echo $product['id']; ?>&table=tblproduct3" 
    ...
    <?php 
        ...
        echo "<div class='col-12'><p class='text-center'>No trousers found in the database.</p></div>";
    }
    ?>
</div>
