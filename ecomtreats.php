...
<div class="brand-showcase">
  <div class="background-accent">
    <div class="text-content">
      ...
      <h1>Finest of makeup</h1>
      <p class="tagline">Explore bestselling makeup brands for your vanity</p>
    </div>
  </div>
    ...
    <div class="carousel-track">
        <div class="carousel-card"> 
            <div class="card-image-wrapper">
                <img src="images/-Tirtir-Top-Banner-Desktop.avif" alt="Tirtir Products">
          
            </div>
        </div>
        <div class="carousel-card">
            <div class="card-image-wrapper">
                <img src="images/_-Nars-Top-Banner-Desktop.avif" alt="Nars Products">
          
            </div>
        </div>
        <div class="carousel-card">
            <div class="card-image-wrapper">
                <img src="images/-MAC-Top-Banner-Desktop.avif" alt="MAC Products">
...
<div class="row row-cols-2 row-cols-lg-3 g-3">
    <?php 
    // Fetch products specifically from tblproduct4 for the treats page
    $query = "SELECT * FROM tblproduct4";
    $result = mysqli_query($conn, $query);
    ...
    ?>
        <div class="col">
            <div class="card custom-card" style="border:none;">
                <!-- Product Image -->
                <img src="images/treats/<?php echo htmlspecialchars($product['image']); ?>" class="card-img-top" alt="Product Image">
                ...
                <div class="card-body">
                    ...
                    <a href="index.php?action=add&pid=<?php echo $product['id']; ?>&table=tblproduct4" 
    ...
    <?php 
        ...
        echo "<div class='col-12'><p class='text-center'>No treats found in the database.</p></div>";
    }
    ?>
</div>
...
<!-- offcanvas cart -->
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const autoPlaySpeed = 4000; // Change slides every 4 seconds

        // 1. Function to move to a specific slide
        ...
        // 2. Auto-play Logic
        let slideTimer = setInterval(nextSlide, autoPlaySpeed);
        ...
        // 3. User Interaction - Stop auto-play when user clicks dots
        dots.forEach((dot, index) => {
            dot.addEventListener('click', () => {
                clearInterval(slideTimer); // Stop auto-play
                goToSlide(index);
                // Restart auto-play after interaction
                slideTimer = setInterval(nextSlide, autoPlaySpeed);
            });
        });

        // 4. Update dots appearance on scroll
        track.addEventListener('scroll', () => {
            ...
            // Sync currentIndex if user swipes manually
            currentIndex = activeIndex;
        });

        // 5. Pause on Mouse Hover (optional, but good UX)
