...
<div class="row row-cols-2 row-cols-lg-3 g-3">
    <?php 
    // Fetch products specifically from tblproduct5 for the treats page
    $query = "SELECT * FROM tblproduct5";
    $result = mysqli_query($conn, $query);
        ...
        <div class="col">
            <div class="card custom-card" style="border:none;">
                ...
                <div class="card-body">
                    ...
                    <a href="index.php?action=add&pid=<?php echo $product['id']; ?>&table=tblproduct5" 
    ...
    <?php 
        ...
        echo "<div class='col-12'><p class='text-center'>No products found in the database.</p></div>";
    }
    ?>
</div>
