...
<div class="row row-cols-2 row-cols-lg-3 g-3">
    <?php 
    // Fetch products specifically from tblproduct7 for the coors page
    $query = "SELECT * FROM tblproduct7";
    $result = mysqli_query($conn, $query);
    ...
    ?>
        <div class="col">
            <div class="card custom-card" style="border:none;">
                <!-- Product Image -->
                <img src="images/coors/<?php echo htmlspecialchars($product['image']); ?>" class="card-img-top" alt="Product Image">
                ...
                <div class="card-body">
                    ...
                    <a href="index.php?action=add&pid=<?php echo $product['id']; ?>&table=tblproduct7" 
    ...
    <?php 
        ...
        echo "<div class='col-12'><p class='text-center'>No coors found in the database.</p></div>";
    }
    ?>
</div>
    ...
    <div class="container-fluid">
        <div class="container">
            <footer class="row row-cols-1 row-cols-sm-2 row-cols-md-5 row-cols-5 row-cols-lg- py-5 my-5 border-top">
                <div class="col mb-3">
